document.addEventListener("DOMContentLoaded", function () {
    ...
    const navLinks = [
        { href: 'index', iconClass: 'fa fa-home', text: 'Home' },
        { href: 'projects', iconClass: 'fa-solid fa-play', iconClass2: 'fa-solid fa-image', text: 'Projects' },
        { href: 'resume', iconClass: 'fa fa-info-circle', text: 'Overview' },
        { href: 'credits', iconClass: 'fa-solid fa-note-sticky', text: 'Credits' }
    ];
    ...
    navLinks.forEach(link => {
        ...
        if (currentPage === 'projects' && link.text === 'Projects') {
        ...
        if (currentPage === 'resume' && link.text === 'Overview') {
            h1.textContent = 'OVERVIEW';
            a.classList.add('btn-outline-primary');
            a.style.color = '#0097ff';
            a.classList.remove('text-white');
            a.style.borderWidth = '0';
            ...
            nav.className = 'nav-wrapper bg-dark p-1 d-flex justify-content-between align-items-center fw-bold border-bottom rounded-bottom border-5 border-primary';

        }

        if (currentPage === 'credits' && link.text === 'Credits') {
